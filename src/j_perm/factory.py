...
from .handlers.ops_async import (
    ...
    AsyncTryHandler, AsyncDeserializeHandler, AsyncSerializeHandler,
    AsyncEncodeHandler, AsyncDecodeHandler,
    AsyncHashHandler,
)
...
def _register_main_ops(main_reg: ActionTypeRegistry, ops: Mapping[str, Any]) -> None:
    ...
    nodes: list[tuple[str, Any, Any]] = [
        ...
        ("serialize", OpMatcher("serialize"), ops["serialize"]),
        ("encode", OpMatcher("encode"), ops["encode"]),
        ("decode", OpMatcher("decode"), ops["decode"]),
        ("hash", OpMatcher("hash"), ops["hash"]),
...
def build_default_engine(
    ...
    ops = {
        ...
        "serialize": SerializeHandler(set_handler=set_handler),
        "encode": EncodeHandler(set_handler=set_handler),
        "decode": DecodeHandler(set_handler=set_handler),
        "hash": HashHandler(set_handler=set_handler),
        "def": DefHandler(),
        "func": CallHandler(),
        "raise": RaiseHandler(),
...
def build_default_async_engine(
    ...
    ops = {
        ...
        "serialize": AsyncSerializeHandler(set_handler=set_handler),
        "encode": AsyncEncodeHandler(set_handler=set_handler),
        "decode": AsyncDecodeHandler(set_handler=set_handler),
        "hash": AsyncHashHandler(set_handler=set_handler),
        "def": AsyncDefHandler(),
